...
Das Erscheinungsbild ist abhängig vom angemeldeten User (Unterschied Gast/Reg-User)
...
-->
<?php
# Aufbau der Session und Überprüfung ob Session bekannt ist.
session_start();
if ($_SESSION["loginOK"] != true) {
    ...
    <html>
        ...
        <body>
            ...
            # Das Ergebnis wird verwendet um die benötigten Inhalte des Blogs darzustellen. Es wird ein prepared Statement genutz -> s. Doku
            ...
            if ($_SESSION['email'] != 'gast') {
                ...
                # Tabelle wird angelegt. Es wird das Formular zum Eintrag erstellen und Suchen erstellt. Links zum Logout und Userprofile bearbeiten.
            ...
            <hr style="background-color:grey;"noshade width="300" align="center">';
                ...
                # Solange Einträge vorhanden sind führe aus:
                while ($stmt->fetch()) {
                ...
                # Falls als Gast angemeldet (ändern der Ansicht)
            } else {
